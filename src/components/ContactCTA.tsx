...
const ContactCTA = () => {
  return (
    <section id="contact" className="page-section bg-leaf-light/30">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <a href="tel:9149958270" className="text-lg font-semibold text-earth-dark hover:text-terracotta transition-colors">
                  +91 91499 58270
                </a>
              </div>
            </div>
