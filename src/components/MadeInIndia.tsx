...
const MadeInIndia = () => {
  return (
    <section id="made-in-india" className="page-section bg-clay-light/30 relative">
      <div className="container mx-auto px-4">
        <h2 className="section-title text-center mx-auto mb-12">Made with Love in India</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            <div className="mb-4 bg-terracotta-light/30 p-4 rounded-full">
              <HandHeart className="h-8 w-8 text-terracotta" />
            </div>
            <h3 className="text-xl font-semibold mb-3 text-terracotta-dark">Rural Artisanship</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            <div className="mb-4 bg-terracotta-light/30 p-4 rounded-full">
              <Flag className="h-8 w-8 text-terracotta" />
            </div>
            <h3 className="text-xl font-semibold mb-3 text-terracotta-dark">Pan India Delivery</h3>
            <p className="text-muted-foreground">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            <div className="mb-4 bg-terracotta-light/30 p-4 rounded-full">
              <IndianRupee className="h-8 w-8 text-terracotta" />
            </div>
            <h3 className="text-xl font-semibold mb-3 text-terracotta-dark">Affordable for Everyone</h3>
            <p className="text-muted-foreground">
